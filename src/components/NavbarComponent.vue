    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-2">
      <router-link class="btn" to="/">
        <a class="flex items-center">
          <img alt="image description" class="h-auto max-w-full scale-75" src="src/assets/img/logo-white.png">
        </a>
      </router-link>
      ...
      <div id="navbar-default" class="hidden w-full md:block md:w-auto">
        <ul
          ...
          <li>
            <router-link v-if="isAuthenticated" class="btn" to="/login" @click="logout">Çıkış
            </router-link>
          </li>
          <li>
